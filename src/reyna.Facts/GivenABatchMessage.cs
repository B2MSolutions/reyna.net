namespace Reyna.Facts
{
    ...
    public class GivenABatchMessage
    {
        ...
        {
            var batchMessage = new BatchMessage(1, "url", "payload");
        ...
        public void WhenSettingUrlShouldThenReturnExpected()
        {
            ...
            var batchMessage = new BatchMessage(1, builder.Uri.ToString(), "payload");
        ...
        {
            var batchMessage = new BatchMessage(12, "url", "PAYLOAD");
        ...
        public void WhenCallingToJsonShouldReturnExpected()
        {
            ...
            var batchMessage = new BatchMessage(12, "http://post.com", payload);
